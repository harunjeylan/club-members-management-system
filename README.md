...
- Option 1: PostgreSQL
  ...
  3. Update the database configuration in the project. Locate the ` .env ` file and provide the necessary details such as host, port, username, password, and database name.
