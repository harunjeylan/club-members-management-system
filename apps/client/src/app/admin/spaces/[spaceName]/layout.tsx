        ...
        <div>
          <ul className="flex w-full gap-4 py-2">
            <li className="link-text font-bold text-md">
              <Link href={`/admin/spaces/${params.spaceName}`}>Home</Link>
            </li>
            <li className="link-text font-bold text-md">
              <Link href={`/admin/spaces/${params.spaceName}/users`}>
                Users
              </Link>
            </li>
            <li className="link-text font-bold text-md">
              <Link href={`/admin/spaces/${params.spaceName}/roles`}>
                Roles
              </Link>
            </li>
            <li className="link-text font-bold text-md">
              <Link href={`/admin/spaces/${params.spaceName}/events`}>
                Events
              </Link>
            </li>
          </ul>
